 ...
 * @author Yosafat
 */
@Path("userprovider/login")
public class UserDomainProviderResource {
     ...
     */
    public UserDomainProviderResource() {
    }
    ...
    public String getJson(@QueryParam("email") String email, @QueryParam("password") String password) {
        return new Gson().toJson(new UserDomainProviderHelper().login(email, password));
    }
